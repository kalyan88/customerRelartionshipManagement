...
<form name="form1" method="get" action="customer.do">
	...
	<TR>
	  <TD COLSPAN=4>&nbsp;</TD>
	  <TD COLSPAN=6>&nbsp;</TD>
	  <TD COLSPAN=13 ROWSPAN=5><table width="100%" border="0">
          <tr>
          ...
          <tr>
            ...
            <td>
              <input type="submit" name="Submit" value="CANCEL"> <span class="style9"><a href="./registration.jsp"><span class="style10">Click here to register?</span> </a></span> </td>
          </tr>
        </table>									</TD>
	  <TD>&nbsp;</TD>
    </TR>
